...
namespace ScreenShot
{
    ...
    *****************************************************************/
    ...
    public class GlassButton : PictureBox, IButtonControl
    {
        ...
        public GlassButton()
        {
            m_glassHotImg = MethodHelper.GetImageFormResourceStream("MyControls.GlassButton.Res.glassbtn_hot.png");
            m_glassDownImg = MethodHelper.GetImageFormResourceStream("MyControls.GlassButton.Res.glassbtn_down.png");
